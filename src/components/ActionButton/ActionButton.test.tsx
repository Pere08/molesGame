...
describe('ActionButton', () => {
  it('should render START button when togglingState is false', () => {
    render(
      <ActionButton togglingState={false} start={() => {}} stop={() => {}} />,
    );
  ...
  it('should render STOP button when togglingState is true', () => {
    render(
      <ActionButton togglingState={true} start={() => {}} stop={() => {}} />,
    );
  ...
  it('should call start function when START button is clicked', () => {
    ...
    render(
      <ActionButton togglingState={false} start={startMock} stop={stopMock} />,
    );
  ...
  it('should call stop function when STOP button is clicked', () => {
    ...
    render(
      <ActionButton togglingState={true} start={startMock} stop={stopMock} />,
    );
